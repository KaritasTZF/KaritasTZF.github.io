...
var TOPPER_HEIGHT    = 1.5;
var TOPPER_WIDTH     = 1.5;
     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 87:	// w - snýr efri armi
                ...
                break;
            case 49:    // 1 - snýr toppur
                theta[3] = Math.min(180, theta[3] + 5);
                break;
            case 50:    // 2 - snýr toppur
			    theta[3] = Math.max(-180, theta[3] - 5);
                break;
         }
     }  );  
...
function topper() 
{
    var s = scalem(TOPPER_WIDTH, TOPPER_HEIGHT, TOPPER_WIDTH);
    var instanceMatrix = mult( translate( 0.0, 0.5*TOPPER_HEIGHT, 0.0), s);
    var t = mult(modelViewMatrix, instanceMatrix);
    gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(t));
    gl.drawArrays( gl.TRIANGLES, 0, NumVertices);
...
var render = function() {
    ...
    modelViewMatrix = mult( modelViewMatrix, rotateY( theta[Topper]));
    topper();
